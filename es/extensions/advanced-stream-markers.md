...
# Marcadores Avanzados de Transmisión 2.0 [(por NotZelda)](https://www.twitch.tv/notzelda)

## Descripción
Permite a los espectadores o emisores activar un marcador de stream que se agrega al VOD de Twitch, pero también a un archivo .txt que muestra una marca de tiempo, duración, título y descripción. Esta extensión también toma la entrada desde un comando si hay uno como la descripción. También crea un nuevo archivo cada transmisión par que no se trate de un solo archivo con una lista larga. Este ejemplo puede ser usado para acelerar la edición de videos después de las transmisiones, ya que provee de contexto a los momentos.
