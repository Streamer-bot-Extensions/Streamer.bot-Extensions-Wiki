...
Cuando abres el portal de desarrolladores con Acceso `Esencial` serás saludado con esto. ![twitterapplyforelevated.png](/assets/twitter/images/twitterapplyforelevated.png)
...
![twitterapplyforelevatedpg1.png](/assets/twitter/images/twitterapplyforelevatedpg1.png) La siguiente sección es donde explicarás tu uso del bot, diciendo algo como:
...
```
# Instalación
Todo el código es un poco de C#, así que todas las referencias deberán ser agregadas en un solo lugar. Las referencias que necesitarás son: ![tweetrefs.png](/assets/twitter/images/tweetrefs.png) También, dentro del código de C# necesitarás agregar tus llaves. ![tweetkeys.png](/assets/twitter/images/tweetkeys.png) Asegúrate de que cada línea de llave tenga `@` al inicio y declarada como una cadena de texto con `"`.

Necesitarás configurar el servidor HTTP en Streamer.bot. La `Dirección` y el `Puerto` deben coincidir con el paso anterior que realizaste en la configuración. ![httpservertwitter.png](/assets/twitter/images/httpservertwitter.png)
