...
> "Después" significa después de que las colas se inicialicen. Es posible que tengas que esperar a que otras características que desees se carguen correctamente (como la conexión a Twitch). 
> 
> {.is-info}
