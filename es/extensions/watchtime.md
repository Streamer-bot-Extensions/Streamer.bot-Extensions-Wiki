...
description: 
published: true
date: 2022-07-24T04:39:18.019Z
tags: 
editor: markdown
dateCreated: 2022-06-14T23:23:17.353Z
---
...
![watchtime-action-menu.png](/extensions/watchtime/images/watchtime-action-menu.png)
![watchtime-action.png](/extensions/watchtime/images/watchtime-action.png)

Create a `Command` called `!watchtime` set to `Exact` and tie it to the `Get Watchtime User` `Action`.
![watchtime-present-user-command.png](/extensions/watchtime/images/watchtime-present-user-command.png)
