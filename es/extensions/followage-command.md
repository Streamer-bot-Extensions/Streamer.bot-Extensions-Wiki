...
# Comando de Antigüedad de Seguimiento

## Antigüedad de Seguimiento Simple [(por TerrierDarts)](https://www.twitch.tv/terrierdarts)
...
## Antigüedad de Seguimiento (con objetivos y fallo) [(por TerrierDarts)](https://www.twitch.tv/terrierdarts)
### Código de Importación
```
...
## ¡Antigüedad de Seguimiento en C# [(por Farlezz)](https://www.twitch.tv/farlezz) & [(por TerrierDarts)](https://www.twitch.tv/terrierdarts)!
### Import Code
```
...
```
### Instalación
En Streamer.bot, en el panel de `Importación` de la parte superior izquierda, copia el `Código de Importación` y pégalo en la `Cadena de Importación`. Al igual que en los ejemplos anteriores, esto solo necesita un comando `!followage` ligado a la acción. ¡Asegúrate que la opción "location" esté configurada como "start", debido a que se desea que el comando acepte cualquier entrada si el usuario así lo decide!