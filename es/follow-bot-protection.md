...
published: true
date: 2022-07-24T04:59:09.501Z
tags: 
editor: markdown
dateCreated: 2022-07-24T00:42:20.944Z
---
...
```
![follow-bot-protection-import2.png](/extensions/follow-bot-protection/images/follow-bot-protection-import2.png) ![follow-bot-protection-import3.png](/extensions/follow-bot-protection/images/follow-bot-protection-import3.png)
...
`C:\Windows\Microsoft.NET\Framework\v4.0.30319` or `C:\Windows\Microsoft.NET\assembly\GAC_MSIL\` It is recommended to search both folders and use the one that works for compiling.
...
> {.is-danger}
 ...
 ## Events Set `Action` `BotCheck` to trigger on `Follows` `Event`.
...
> By default it is off as the variable does not exist yet. Variable will be created on first use of !toggleban it will send chat message of `@user Ban: False or @user Ban: True` False = Off and True = On 
> 
> {.is-warning}
...
Names can be part of the whole username in case of hoss these cover them all that are known so far. It is **recommended** to add as much of the name as possible, so there won't be many false bans for legit users who follow and have the string as part of their name.
