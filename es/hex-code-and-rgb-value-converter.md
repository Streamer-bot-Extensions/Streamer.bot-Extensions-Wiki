...
## Formatting
### Hex to rgb
You can either convert one color or two. If you are only converting one color, the format can be either `!cconvert hexcode` or `!cconvert #hexcode`, eg. `!cconvert 12FF19` or `!cconvert #12FF19`. If you are converting two colors, the first hex needs to have a `#` in front of hexcode, the second hexcode doesn't need it, but will work with it, eg. `!cconvert #12FF19 12FF19` or `!cconvert #12FF19 #12FF19`.
