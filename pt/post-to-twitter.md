...
## Streaming Commands
These 2 Actions will need to be tied to the OBS Events > Stream Started and OBS Events > Stream Stopped The Arguments in both sub-actions are exactly the same however you will have a **LIVE** verson and you will have a **Normal** Version for when you are offline.
| Argument     | Purpose                                                                                                                                                                         |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
