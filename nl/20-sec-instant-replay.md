...
published: true
date: 2022-07-24T05:10:31.617Z
tags: replay, rewind, effect
editor: markdown
dateCreated: 2022-07-24T00:58:37.467Z
---

# 20 Second Instant Replay [(by MarkusoOoO)](https://www.twitch.tv/markusoooo)

## Description
This is my take for 20s instant replay using streamer.bot, based on Nutty's video. Make sure to follow his [video](https://youtu.be/NuWKrpNCE1k) for setting up OBS at least with `Nested scenes` & `Dynamic Delay Filter`. Whole effect takes about `8GB of your RAM`, so be aware of that.
