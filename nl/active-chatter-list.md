...
published: true
date: 2022-07-24T05:10:49.692Z
tags: 
editor: markdown
dateCreated: 2022-07-24T00:59:02.918Z
---
...
## Installation
Copy the import string below and paste it into the `Import Pane`.
```text
...
## Configuration
Double click the `Subaction` `Write to file` and then change the `File Path` to point to a valid text file. ![active-chatter-write-to-file.png](/extensions/active-chatter-list/images/active-chatter-write-to-file.png)

Next tie the `First Words` `Action` to the `First Words Event`. ![active-chatter-first-words-event.png](/extensions/active-chatter-list/images/active-chatter-first-words-event.png)
