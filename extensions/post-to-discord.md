...
## Description
With this extension, you can post to discord. This could be anything from Images to Clips.. Could even be used to post a going live message.
...
![post-to-discord-obs-raw.png](/extensions/post-to-discord/images/post-to-discord-obs-raw.png)
...
string Webhook_link = "PASTE YOUR WEBHOOK URL HERE";
 ...
 ![post-to-discord-obs-references.png](/extensions/post-to-discord/images/post-to-discord-references.png)