...
This will add four Actions in a group called "INI File". The four actions are
...
INI - Get Action, and INI - Set Action are both example actions to help demonstrate and let you experiment with how INIFile - Get Data, and INIFile - Set Data are used.
