...
![heatcooldownaction1.png](/extensions/heat-map/images/heatcooldownaction1.png)
This is the Name of the cooldown, if you want multiple actions in the same cooldown just add the same name.
![heatcooldownaction2.png](/extensions/heat-map/images/heatcooldownaction2.png)
This will trigger the cooldown check, Select User or Global depending on which cooldown you want.
![heatcooldownaction3.png](/extensions/heat-map/images/heatcooldownaction3.png)
