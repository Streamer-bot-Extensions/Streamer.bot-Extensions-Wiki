...
published: true
date: 2022-07-24T04:53:09.286Z
tags: 
editor: markdown
dateCreated: 2022-07-24T00:33:54.330Z
---

# .ini Files [(by Robophill)](https://www.twitch.tv/robophill)
...
The INI - Get Action ![INI_File_Get_Action.png](/extensions/ini-files/images/INI_File_Get_Action.png)

and INI - Set Action ![INI_File_Set_Action.png](/extensions/ini-files/images/INI_File_Set_Action.png)
...
So we have a Section named "Robophill", a Key named "Points", and the Content as "123". If we wanted to Get this information we would set the global variables to
...
If we wanted to Set information we would set the global variables the same way we did to Get the information, but now we also set INIKeyContent to what we want saved in the ini file. So if we set INIKeyContent to 321, that would replace the 123 in the ini file.
