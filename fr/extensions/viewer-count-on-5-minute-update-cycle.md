...
published: true
date: 2022-07-24T04:42:50.602Z
tags: counter, basic, easy
editor: markdown
dateCreated: 2022-06-14T23:30:06.909Z
---

# Viewer Count on 5 Minute Update Cycle [(by MarkusoOoO)](https://www.twitch.tv/markusoooo)

## Description
For anyone who would like to use SB only for viewers counter, which will be updated every 5 minutes. 
You can use variable which exists only when you hit Start Streaming and you have to have action assigned into `Present Viewers (occurs every 5 minutes)` event.
