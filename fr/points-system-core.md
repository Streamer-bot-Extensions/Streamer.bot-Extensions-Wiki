...
published: true
date: 2022-07-24T05:07:51.463Z
tags: 
editor: markdown
dateCreated: 2022-07-24T00:54:46.377Z
---

# Points System [(by VRFlad)](https://www.twitch.tv/VRFlad)

## Description

This is the Core Points System needed to utilize all the extensions on this page.  This Points System by VRFlad will allow your viewers to gain channel points while viewing your stream.  Coupled with the other extensions it will allow your viewers to spend points on chat games, giveaways, and more all without the need for Twitch Affiliation!

## Tutorial

<br>
<iframe width="1120" height="630" src="https://www.youtube.com/embed/VCnoT7wqNrE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
![points-system-raid.png](/extensions/points-system/images/points-system-raid.png) ![points-system-host.png](/extensions/points-system/images/points-system-host.png)
...
![points-system-set-points-command.png](/extensions/points-system/images/points-system-set-points-command.png)
...
> For example when a user uses `!points` in chat it will return `user, you have points pointsname.` (i.e `VRFlad, you have 100 UFO's.`) 
> 
> {.is-info}
...
![points-system-buywithpoints-sample-command.png](/extensions/points-system/images/points-system-buywithpoints-sample-command.png)
...
![points-system-cc-reset.png](/extensions/points-system/images/points-system-cc-reset.png)
